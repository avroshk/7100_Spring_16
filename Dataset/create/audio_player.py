...
duration = 9
filename = '/Users/avrosh/Documents/Coursework/7100_Spring_16/Dataset/data/3/FEAB_Se.wav'
...
fig = plt.figure(figsize=(duration,5))
...
timer.add_callback(playhead.update, time_posn)
timer.start()
